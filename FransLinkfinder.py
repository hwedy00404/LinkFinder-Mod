...
class BurpExtender(IBurpExtender, IHttpListener, IScannerCheck, ITab):
    ...
    def doPassiveScan(self, ihrr):
     ...
     # This is the "bridge" function that will run the old code on the proxy
    def processHttpMessage(self, toolFlag, messageIsRequest, messageInfo):
        # 1. If the message “Response” comes from the proxy (Flag 4)
        if not messageIsRequest and toolFlag == 4:
            # 2. Call your old function and it will act
